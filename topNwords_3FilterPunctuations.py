...
print ' Maximum Entropy classifier by removing punctuations: '
# print(punctuations)
# Create stop set of stopwords.
...
def word_feats(words):
    return {word:True for word in words if word in top_words and word not in punctuations}
